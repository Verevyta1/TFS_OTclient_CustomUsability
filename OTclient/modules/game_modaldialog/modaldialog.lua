...
local function getRandomPosition(maxWidth, maxHeight)
  local x = math.random(0, maxWidth)
  local y = math.random(0, maxHeight)
  return x, y
end
...
function init()
  ...
  dialog = rootWidget:recursiveGetChildById('modalDialog')
